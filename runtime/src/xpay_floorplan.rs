...
use rstd::vec::Vec;
pub fn add_floorplan<T:Trait>(origin: T::AccountId,item_id:T::ItemId,address:Vec<u8>,cubes:Vec<(usize,i16,i16,i16)>,desc:Vec<u8>,image:Vec<u8>,ipfs:Vec<u8>)->Result{
...
pub fn change_floorplan<T:Trait>(item_id:T::ItemId,address:Vec<u8>,cubes:Vec<(usize,i16,i16,i16)>,desc:Vec<u8>,image:Vec<u8>,ipfs:Vec<u8>)->Result{
